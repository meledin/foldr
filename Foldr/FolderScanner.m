...
- (id) init
{
    ...
    if (self)
    {
        ...
        contents = [NSMutableDictionary dictionaryWithContentsOfFile:@"~/Pictures/Foldr/.foldrIndex"];
    ...
    @synchronized(self)
    {
        ...
        for (int i=0; i<keys.count; i++)
        {
            ...
            if (!value)
            {
                ...
                [[Foldr instance] itemCreated: realItem atPath:[self getRelativePath:newPath]];
            }
            else
            {
